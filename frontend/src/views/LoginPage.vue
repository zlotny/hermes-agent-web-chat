  ...
  <div class="min-h-screen bg-app-bg flex items-center justify-center relative overflow-hidden">
    ...
    <div class="bg-surface/80 backdrop-blur-sm border border-border/60 rounded-xl p-8 w-[360px] relative z-10 shadow-2xl shadow-black/40 animate-fade-in">
      <div class="flex flex-col items-center mb-6">
        ...
        <h1 class="text-lg font-semibold text-default">Welcome to<br><span class="text-accent text-xl">Hermes Agent</span></h1>
      ...
      <form @submit.prevent="login">
        ...
        <input id="pwd" v-model="password" type="password" autofocus
          class="w-full px-3 py-2.5 bg-app-bg border border-border rounded-md text-default text-sm outline-none mb-5 focus:border-accent/70 transition-colors" />
