      ...
      <div class="flex items-center justify-between px-4 py-4 border-b border-border" style="padding-top: calc(0.75rem + env(safe-area-inset-top, 0px));">
        ...
        <div class="flex items-center gap-1">
          ...
          <button
            ...
            @click="newChat"
            class="p-1.5 rounded-md hover:bg-hover-bg text-muted hover:text-default transition-colors"
            title="New chat"
          >
          ...
          <button
            ...
            class="p-1.5 hover:bg-hover-bg text-muted hover:text-default transition-colors"
      ...
      <div class="border-t border-border">
        <div class="px-3 py-2">
          <div class="relative">
            ...
            <input
              v-model="sessionsStore._rawSearch"
              type="text"
              placeholder="Search sessions…"
              class="w-full bg-app-bg border border-border pl-7 pr-2.5 py-1.5 text-xs text-default outline-none placeholder:text-muted/40 focus:border-accent/50 transition-colors"
            />
          </div>
        </div>
        <SettingsFooter />
